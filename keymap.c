...
#define LANG_TWO_LAYERS(\
  ...
  [L_DEFAULT] = MY_layout( \
    ...
    AG_CMSP,    RH1,     RH2,     RH3,     RH4,     RH5,     RH6, \
             RD1,     RD2,     RD3,     RD4,     RD5,     TG(L_MOUSE), \
                      LA_CHNG,  TG(L_MOUSE), LA_CTSP, LA_SYNC, EN_GRV, \
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_MOUSE] = MY_layout(
    ...
    _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______,
    _______, _______, KC_BSPACE, KC_LGUI, SFT_N, _______, _______,
    _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, 
    _______, // LEFT RED THUMB KEY
    KC_MS_BTN1, KC_MS_BTN2, _______, // LEFT THUMB KEYS

    // RIGHT HALF
    _______, _______, _______, _______, _______, _______, _______,
    _______, KC_MS_WH_UP, KC_MS_BTN1, KC_MS_UP, KC_MS_BTN2, _______, _______,
    _______, KC_MS_WH_DOWN, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT, _______, _______,
    _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, 
    _______, // RIGHT RED THUMB KEY
    _______, _______, _______ // RIGHT THUMB KEYS
